...
function ButtonChat({ type, className, handleClick }: Props) {
  return (
    <div className="d-flex align-center h-32-px font-26">
      <a type={type} onClick={handleClick} className={`${className} pt-3`}>
        <svg
          className="css-9oofjg-StyledIcon e1nx07zo1"
          width="1em"
          data-e2e=""
          height="1em"
          viewBox="0 0 48 48"
